...
# --- 1. واجهة النخبة (The Elite Cyber UI) ---
...
if not st.session_state['auth']:
    ...
    with col_l:
        ...
        st.markdown("<div class='info-panel'>ID: SEC_NODE_01<br>FREQ: 5.8 GHz<br>SIGNAL: 92%<br>DECRYPTOR: ACTIVE</div>", unsafe_allow_html=True)
    ...
    with col_r:
        ...
        st.markdown("<div class='info-panel'>PAYLOAD: ACTIVE<br>PROXY: ENABLED<br>THREADS: 256<br>SEC_BYPASS: TRUE</div>", unsafe_allow_html=True)
else:
    ...
    if uploaded_file is not None:
        ...
        is_ai = variance < 400 or sat_mean > 110
